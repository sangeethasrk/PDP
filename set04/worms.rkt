...
; B) Worm sttructure can be as follows
; (define-struct worm [listOfPositions Direction length]
; The length here indicating the count of the number of ssegments in the worm.
